...
export default function Projects() {
  ...
  // Which months have data for the current year + selected sector?
  ...
  // Which sectors have data for the current year + selected month?
  ...
  // --- Handlers: each filter change auto-resets conflicting sibling filters ---
        ...
        <div className="container mx-auto px-6 md:px-8 max-w-7xl">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-10 px-2">
            <p className="label-mono text-[11px] text-foreground/40 flex items-center gap-2" aria-live="polite" role="status">
              ...
              Showing {visibleWork.length} of {filteredWork.length} Project Results
            </p>
          ...
          <div className="mt-32 grid grid-cols-1 lg:grid-cols-2 gap-12 border-t border-outline/30 pt-24">
            <div className="space-y-6">
              <h3 className="font-headline text-3xl md:text-4xl font-bold text-foreground tracking-tighter">
                Engineering <br className="hidden md:block" /> <span className="text-accent italic font-normal underline decoration-accent/30 underline-offset-8">Excellence</span> Since 1993
              </h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-8 rounded-3xl bg-surface border border-outline/30 flex flex-col justify-between group hover:border-accent/40 transition-colors">
                <span className="label-mono text-[10px] text-foreground/40 uppercase tracking-widest mb-4 block">Successful Deliveries</span>
